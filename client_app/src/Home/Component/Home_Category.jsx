...
function Home_Category(props) {
    ...
    const [load_category, set_load_category] = useState('category_1')
                    ...
                    <div className="col-lg-12">
                        <div className="li-product-tab">
                            <ul className="nav li-product-menu">
                                <li><a className="active" data-toggle="tab" href="#" onClick={() => handler_change_category('category_1')}><span>Gà Giòn Vui Vẻ</span></a></li>
                                <li><a data-toggle="tab" href="#" onClick={() => handler_change_category('category_5')}><span>Phần Ăn Phụ</span></a></li>
                            ...
                            <div className="product-active fix_product_category">
                                {
                                    product_category && product_category.map(value => (
                                        <div className="col-lg-4" key={value.id_product}>
